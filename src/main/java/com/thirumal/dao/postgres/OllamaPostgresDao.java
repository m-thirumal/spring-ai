 ...
 * 
 */
package com.thirumal.dao.postgres;
 ...
 */
@Repository
public class OllamaPostgresDao extends AbstractOllamaDao<OllamaChat> {


	public OllamaPostgresDao(@Qualifier("postgresJdbcClient")JdbcClient jdbcClient, OllamaChatModel ollamaChatModel) {
